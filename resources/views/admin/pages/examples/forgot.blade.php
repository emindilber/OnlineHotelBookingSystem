...
<div class="register-box">
  <div class="register-logo">
    <a style="color: #090942"><b>Şifremi Unuttum</b></a>
  </div>
  ...
  <a style="color: #090942">Üyelik bilgilerinizi giriniz.</a>
...
@endif
    ...
    {{ csrf_field() }}
      ...
      <div class="form-group has-feedback">
        <input type="password" class="form-control" name="sifre_t" placeholder="Yeni Şifrenizi Giriniz" required>
        <span class="glyphicon glyphicon-log-in form-control-feedback"></span>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-xs-12 text-center">
          <button type="submit" class="btn btn-primary btn-flat" style="background: #38AFE4">
              <a href="login"><b style="color: #090942">Şifre Yenile</b></a>
          </button>
        </div>
        <!-- /.col -->
      </div>
