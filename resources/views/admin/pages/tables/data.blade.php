...
<head>
  ...
  <title>Admin | Kullanıcı Bilgileri</title>
  ...
  <div class="content-wrapper">
   ...
   @endif
                ...
                @foreach ($veriler as $veri)
                    <td>{{ $veri->kullanici_adi  }} {{ $veri->kullanici_soyadi }}</td>
                  <td>{{ $veri->kullanici_mail }}</td>
                  <td>{{ $veri->kullanici_tel }}</td>
                  <td> {{ $veri->kullanici_tc }}</td>
                  <td>
                  <a href="uye_sil/{{ $veri->giris_bilgileri_id }}"><i class="fa fa-trash-o" aria-hidden="true"></i>
                  </a>
