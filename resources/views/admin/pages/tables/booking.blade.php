...
<head>
  ...
  <title>Admin | Giriş Bilgileri</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Giriş Bilgileri</li>
      </ol>
    </section>
   ...
   @endif
                ...
                @foreach ($veriler as $veri)
                  <td>{{ $veri->rezervasyon_id  }}</td>
                  <td>{{ $veri->baslangic_tarihi }}</td>
                  <td>{{ $veri->bitis_tarihi }}</td>
                  <td>{{ $veri->oda_id }}</td>
                  <td>{{ $veri->kullanici_id }}</td>
                  <td>
                  <a href="rezervasyon_sil/{{ $veri->rezervasyon_id }}"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                  </td>
